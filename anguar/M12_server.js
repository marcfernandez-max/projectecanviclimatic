...
/**
 * [ES] Servidor HTTP (Node.js) de apoyo para ejemplos.
 *
 * Qué hace:
 * - Expone endpoints simples (`/consultarTots`, `/afegirAlumne`) con JSON.
 * - Añade cabeceras CORS para permitir llamadas desde el frontend Angular en local.
 * - Sirve un mp3 en `/audio1.mp3` como ejemplo de contenido binario.
 *
 * Esto **no** es parte del runtime de Angular; es un backend de demostración.
 */
